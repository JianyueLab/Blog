...
function Works() {
  let resume = [
    {
      company: 'TecoStudio (tecostudio.cn)',
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        <BriefcaseIcon className="h-6 w-6 flex-none" />
        <span className="ml-3">Works & Orgs</span>
      </h2>
      <ol className="mt-6 space-y-4">
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            ...
            <dl className="flex flex-auto flex-wrap gap-x-2">
              <dt className="sr-only">Works & Orgs</dt>
              <dd className="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">
                {role.company}
              </dd>
              <dt className="sr-only">Role</dt>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I am JianyueHugo, aka Valor, a student and a developer in Japan. I am a member of TecoStudio."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I am JianyueHugo, a.k.a. JianyueLab, Valor, 15 y.o., a student and a developer in Japan.
          </p>
